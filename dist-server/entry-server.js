...
const LandingPage = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-[#0d0d0d] relative overflow-hidden flex flex-col font-sans", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-[800px] h-[800px] bg-[#C5A059] opacity-[0.03] rounded-full blur-[120px] pointer-events-none z-0" }),
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#6A2C91] opacity-[0.03] rounded-full blur-[120px] pointer-events-none z-0" }),
