        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-5 space-y-6">
                    <Card className="luxury-card p-6 bg-black/40 backdrop-blur-xl border-white/10">
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <Select value={assetType} onChange={(e) => setAssetType(e.target.value)} className="h-12 bg-white/5 border-white/10">
                                ...
                                <div>
                                    ...
                                    <Select value={imageSize} onChange={(e) => setImageSize(e.target.value as any)} className="h-12 bg-white/5 border-white/10">
                                ...
                                <div>
                                    ...
                                    <Select value={aspectRatio} onChange={(e) => setAspectRatio(e.target.value)} className="h-12 bg-white/5 border-white/10">
                                ...
                                <div>
                                    ...
                                    <Select value={style} onChange={(e) => setStyle(e.target.value)} className="h-12 bg-white/5 border-white/10">
                            ...
                            <Button onClick={handleGenerate} className="w-full bg-gradient-to-r from-[#C5A059] to-[#b08e4d] text-white h-14 rounded-2xl shadow-lg border-none" disabled={isGenerating}>
                            ...
                            {generatedImage ? (
                                ...
                                >
                                    <div className="flex-1 w-full flex items-center justify-center mb-8">
                                        <img src={generatedImage} alt="Generated" className="max-w-full max-h-[500px] object-contain rounded-2xl shadow-2xl border border-white/10" />
                                    </div>
                                    <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md mx-auto">
                                        <Button variant="outline" onClick={() => setGeneratedImage(null)} className="flex-1 h-14 rounded-full text-xs font-sans font-medium text-gray-400 border-white/10 hover:bg-white/5">Discard Node</Button>
                                        <Button onClick={handleSave} className="flex-[2] bg-[#6A2C91] hover:bg-[#5a257a] text-white h-14 rounded-full font-sans font-medium text-xs tracking-wide shadow-md">Approve & Send to Vault</Button>
                                    </div>
                                </motion.div>
                            ) : (
                                <motion.div 
                                ...
                                >
                                    <div className="w-24 h-24 bg-white/5 rounded-[1.5rem] flex items-center justify-center text-white/20 mx-auto shadow-sm group-hover:scale-105 transition-transform duration-700 border border-white/10">
