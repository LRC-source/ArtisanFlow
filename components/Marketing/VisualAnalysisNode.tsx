...
import { Eye, TrendingUp, BarChart3, Activity, Download, Instagram, Film, FileText, ArrowRight, DollarSign, Package , Save } from 'lucide-react';
        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-6">
                <Card className="p-4 sm:p-5 lg:p-6 bg-black/40 border-white/5 backdrop-blur-xl">
                    ...
                    <div className="text-xl sm:text-3xl lg:text-5xl font-bold sm:font-black text-white mb-4 font-sans">124.5K</div>
                ...
                <Card className="p-4 sm:p-5 lg:p-6 bg-black/40 border-white/5 backdrop-blur-xl">
                    ...
                    <div className="text-xl sm:text-3xl lg:text-5xl font-bold sm:font-black text-white mb-4 font-sans">8.2%</div>
                ...
                <Card className="p-4 sm:p-5 lg:p-6 bg-black/40 border-white/5 backdrop-blur-xl">
                    ...
                    <div className="text-xl sm:text-3xl lg:text-5xl font-bold sm:font-black text-white mb-4 font-sans">$18,450</div>
                ...
                <Card className="p-4 sm:p-5 lg:p-6 bg-black/40 border-white/5 backdrop-blur-xl" title="Channel Conversion Breakdown">
                    ...
                    <div className="mt-6 sm:mt-8 lg:mt-12 p-4 sm:p-6 rounded-2xl bg-white/5 border border-white/10">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h4 className="text-white font-sans">AI Insight</h4>
                        </div>
