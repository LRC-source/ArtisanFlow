      ...
      <div className="max-w-7xl mx-auto py-12 animate-in fade-in duration-700 pb-32">
        ...
        <div className="w-full md:w-1/2 mb-12">
            <div className="flex items-center gap-4 mb-4">
                ...
                <h1 className="text-4xl md:text-5xl font-serif text-white font-bold tracking-tight">Synaptic Pulse Check</h1>
            </div>
            <p className="text-gray-500 font-sans font-light text-lg">Lola AI is establishing operational health benchmarks. Deployment: 60 Seconds.</p>
            
            <div className="mt-12 flex items-center gap-4 text-[10px] font-sans font-medium uppercase tracking-[0.2em]">
        ...
        <div className="w-full md:w-1/2">
            <Card className="luxury-card p-4 sm:p-12">
                ...
                <div className="flex justify-end pt-12 mt-12 border-t border-stone-100">
                    <Button 
    ...
    <div className="max-w-7xl mx-auto py-12 animate-in fade-in duration-700 pb-32">
        <div className="w-full md:w-1/2 mb-12">
            <div className="flex items-center gap-4 mb-4">
                ...
                <h1 className="text-4xl md:text-5xl font-serif text-white font-bold tracking-tight">Synthesis Complete</h1>
            </div>
            ...
            <Card className="luxury-card text-center pb-16 p-4 sm:p-12">
                ...
                <div className="mt-12 bg-red-50/50 border border-red-100/50 rounded-[3rem] p-4 sm:p-10 flex flex-col sm:flex-row items-center gap-4 sm:p-8 text-left relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <h4 className="text-2xl font-serif text-red-700 tracking-tight mb-3">HIGH RISK: BURNOUT PROTOCOL</h4>
                        <p className="text-sm text-red-800/70 font-sans font-light leading-relaxed">
            ...
            <div className="mt-12 bg-gradient-to-br from-[#1A1A1A] to-[#333333] p-px rounded-[3rem] shadow-2xl">
                <div className="bg-white rounded-[2.9rem] p-4 sm:p-12 md:p-16 text-center relative overflow-hidden group">
                    ...
                    <div className="flex items-center justify-center gap-4 mb-6 text-[#1A1A1A]">
                        ...
                        <h3 className="text-3xl font-serif tracking-tight">The Synaptic Cure</h3>
                    </div>
                    <p className="text-gray-500 font-sans font-light mb-12 leading-relaxed text-lg">Lola AI has synthesized the following corrective directives for <strong className="font-medium text-gray-900">{formData.industry || 'your business'}</strong>:</p>

                    <div className="space-y-4 mb-12">
                        {['Predictive Demand Synthesizer', 'Automated Reorder Optimization', 'Production Floor Flow Balancer'].map(item => (
                            <div key={item} className="flex items-center gap-6 p-6 bg-stone-50/50 rounded-full border border-stone-100 group/li hover:bg-[#6A2C91]/5 hover:border-[#6A2C91]/20 transition-all duration-500">
                                <div className="w-10 h-10 rounded-full bg-white text-[#6A2C91] flex items-center justify-center text-[10px] font-sans font-medium shadow-sm group-hover/li:bg-[#6A2C91] group-hover/li:text-white transition-all duration-500">✓</div>
                                <span className="text-sm font-sans font-medium text-gray-700 tracking-wide">{item}</span>
                            </div>
                        ))}
                    </div>

                    <Button onClick={handleGenerateStrategy} className="w-full h-16 bg-[#1A1A1A] text-white font-sans font-medium uppercase text-[11px] tracking-[0.2em] shadow-[0_8px_30px_rgba(0,0,0,0.12)] rounded-full relative overflow-hidden group/btn hover:bg-[#333333] transition-all duration-500">
