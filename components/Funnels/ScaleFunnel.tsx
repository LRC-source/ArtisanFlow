...
const ScaleFunnel = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white sm:text-gray-300 font-sans selection:bg-[#d4af37] selection:text-black">
      
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-x-hidden pt-20 pb-16">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <motion.div 
            ...
            className="w-full w-full max-w-4xl mx-auto text-center"
          >
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-col sm:flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              <button 
                onClick={handleCTA}
                className="w-auto px-8 py-4 bg-gradient-to-r from-[#d4af37] to-[#b38b22] text-black font-bold rounded-lg text-sm sm:text-base leading-relaxed hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all flex items-center justify-center group"
              >
                Lock In Your Profit Margins
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <p className="text-sm sm:text-base text-gray-500 sm:ml-4">Zero-risk 14-day deployment.</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-6 sm:py-12 lg:py-16 px-4 sm:px-8 bg-[#111] border-y border-[#222]">
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-3 sm:gap-6">
              {[
                ...
                <motion.div key={i} variants={fadeIn} className="bg-gradient-to-b from-[#1a1a1a] to-[#111] p-3.5 sm:p-6 lg:p-12 rounded-xl border border-[#333] hover:border-[#d4af37]/30 transition-colors">
      ...
      <section className="py-6 sm:py-12 lg:py-16 px-4 sm:px-8 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center mb-24">
            <motion.div 
            ...
            >
              ...
              <p className="text-sm sm:text-base text-white sm:text-gray-400 mb-6 leading-relaxed">
              ...
              <ul className="space-y-4">
                {['Dynamic landed cost calculations', 'Supplier price variance alerts', 'Automated tiered pricing enforcement'].map((feature, i) => (
                  <li key={i} className="flex items-center text-white sm:text-gray-300">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative rounded-2xl overflow-x-hidden border border-[#333] shadow-2xl shadow-[#d4af37]/10"
            >
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
              <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=1000" alt="Data dashboard" className="w-full h-full object-cover" />
            </motion.div>
          </div>

          <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center flex-col-reverse lg:flex-col sm:flex-col sm:flex-row">
            <motion.div 
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative rounded-2xl overflow-x-hidden border border-[#333] shadow-2xl shadow-[#d4af37]/10 order-2 lg:order-1"
            >
               <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
              <img src="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=1000" alt="Warehouse logistics" className="w-full h-full object-cover" />
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
      ...
      {/* Social Proof */}
      <section className="py-6 sm:py-12 lg:py-16 px-4 sm:px-8 bg-[#0a0a0a] border-y border-[#222]">
        <div className="container mx-auto px-4">
           <motion.div 
          ...
          <div className="grid md:grid-cols-2 gap-3 sm:gap-6 w-full w-full max-w-4xl mx-auto">
            <div className="bg-[#111] p-3.5 sm:p-6 lg:p-12 rounded-xl border border-[#333] relative">
              <div className="absolute top-0 right-0 p-4 opacity-10">
                <TrendingUp className="w-14 h-14 sm:w-24 sm:h-24" />
              </div>
              <p className="text-sm sm:text-base leading-relaxed text-white sm:text-gray-300 italic mb-6 relative z-10">"Before Artisan Flow, our B2B portal was constantly out of sync with our main warehouse, leading to cancelled orders and furious distributors. Now, our inventory is unified, and our margins are up 14% due to the Profit Guard system."</p>
            ...
            <div className="bg-[#111] p-3.5 sm:p-6 lg:p-12 rounded-xl border border-[#333] relative">
               <div className="absolute top-0 right-0 p-4 opacity-10">
                <BarChart3 className="w-14 h-14 sm:w-24 sm:h-24" />
              </div>
              <p className="text-sm sm:text-base leading-relaxed text-white sm:text-gray-300 italic mb-6 relative z-10">"The BOM forecasting alone paid for the system in the first month. We no longer have production lines sitting idle waiting for raw materials. It's a complete game-changer for physical product scaling."</p>
              <div className="flex items-center">
      ...
      {/* Footer CTA */}
      <section className="py-6 sm:py-12 lg:py-16 px-4 sm:px-8 relative overflow-x-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1500] to-[#0a0a0a] z-0"></div>
        <div className="container mx-auto px-4 relative z-10 text-center w-full w-full max-w-3xl">
          <motion.h2 
          ...
          <p className="text-sm sm:text-base mt-6 text-gray-500">Includes white-glove onboarding for enterprise accounts.</p>
        </div>
      </section>
    </div>
  );
