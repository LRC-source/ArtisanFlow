...
export const SubscriptionManagement = () => {
    ...
    return (
        ...
        >
            ...
            <div className="luxury-card bg-black/40 backdrop-blur-xl border border-white/10 p-4 sm:p-12 flex flex-col md:flex-row justify-between items-center gap-4 sm:p-10 relative overflow-hidden group rounded-[3rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:p-8 mt-12">
               ...
               <div className="luxury-card bg-black/40 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-4 sm:p-10 flex flex-col justify-center items-center text-center group">
