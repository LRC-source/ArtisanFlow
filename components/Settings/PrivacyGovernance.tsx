    ...
    return (
        ...
        >
            <div className="w-full md:w-1/2">
                ...
                <h1 className="text-5xl md:text-7xl font-serif tracking-tighter text-white leading-none drop-shadow-[0_10px_20px_rgba(0,0,0,0.4)] mb-6">Security & Governance</h1>
