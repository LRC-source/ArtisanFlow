    ...
    return (
        ...
        >
            <div className="w-full md:w-1/2">
                <button onClick={() => navigate('/')} className="flex items-center gap-2 text-white sm:text-white/50 hover:text-[#C5A059] font-sans text-xs uppercase tracking-widest transition-colors mb-6 w-fit">
                    <ArrowLeft size={16} /> Back to Dashboard
                </button>
                <h1 className="text-5xl md:text-7xl text-white leading-none drop-shadow-[0_10px_20px_rgba(0,0,0,0.4)] mb-6 font-serif font-bold">Security & Governance</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6">
                <div className="luxury-card bg-black/40 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-4 sm:p-10">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white mb-4 font-display font-medium uppercase tracking-widest">Security Protocols</h2>
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-col sm:flex-col sm:flex-row items-start sm:items-center justify-between p-4 sm:p-6 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-blue-500/30 transition-all duration-500 group">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="text-sm sm:text-base text-white text-white sm:text-slate-400 leading-relaxed tracking-tight font-sans">GDPR & CCPA Handshake</p>
                            ...
                            <Badge color="blue" className="shadow-sm text-[9px] uppercase px-3 py-1 border-blue-500/20 font-cta font-semibold tracking-[0.08em]">Compliant</Badge>
                        </div>
                    </div>
                </div>
                ...
                <div className="luxury-card bg-black/40 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-3.5 sm:p-6 lg:p-12 flex flex-col h-full">
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white mb-4 font-display font-medium uppercase tracking-widest">System Audits</h2>
                    ...
                    <Button variant="outline" className="w-full w-auto mx-auto py-1 px-3 text-[10px] mt-8 rounded-full border-white/20 text-white sm:text-white/70 text-[10px] uppercase hover:bg-white/10 hover:text-white transition-colors font-cta font-semibold tracking-[0.08em]">
