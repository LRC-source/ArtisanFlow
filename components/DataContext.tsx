...
export const ArtisanDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [integrations, setIntegrations] = useState<Integration[]>([
    { 
      ...
      description: 'Syncs orders, updates stock levels, and tracks raw materials.',
      aiCapability: 'Predictive Stock Reconciliation',
      features: ['Order Sync', 'Stock Levels', 'Raw Material Deduction'],
      lastSync: undefined
    },
    { 
      id: 'etsy', 
      ...
      description: 'Imports sales and manages purchase-to-sale product traceability.',
      aiCapability: 'Product Traceability Engine',
      features: ['Sales Import', 'Purchase-to-Sale Traceability', 'Listing Sync'],
      lastSync: undefined
    },
    { 
      id: 'faire', 
      ...
      category: 'Wholesale', 
      status: 'Connect', 
      logo: 'https://logo.clearbit.com/faire.com', 
      description: 'Automatically brings in wholesale orders alongside retail data.',
      aiCapability: 'Wholesale Order Reconciliation',
      features: ['Wholesale Sync', 'B2B Catalog Management', 'Multi-Channel Retail'],
      lastSync: undefined
    },
    { 
      id: 'amazon', 
      ...
      description: 'Tracks marketplace orders and restock needs.',
      aiCapability: 'Restock Demand Predictor',
      features: ['Marketplace Orders', 'FBA Restock Alerts', 'Channel Ledger'],
      lastSync: undefined
    },
    { 
      id: 'woocommerce', 
      ...
      description: 'Connects WordPress stores to keep production inventory aligned.',
      aiCapability: 'Production Stock Alignment',
      features: ['WordPress Sync', 'Bidirectional Push', 'REST API Link'],
      lastSync: undefined
    },
    {
      id: 'square',
      ...
      description: 'Syncs in-person point-of-sale transactions with your main inventory.',
      aiCapability: 'POS Multi-Location Deduction',
      features: ['Point-of-Sale Sync', 'In-Person Deductions', 'Real-time Receipts'],
      lastSync: undefined
    },
    {
      id: 'wix',
      ...
      description: 'Pulls e-commerce orders to adjust material and product counts.',
      aiCapability: 'Material Count Auto-Adjustment',
      features: ['Order Auto-Pull', 'Product Count Sync', 'Material Deductions'],
      lastSync: undefined
    },
    {
      id: 'squarespace',
      ...
      description: 'Imports online shop products and order information.',
      aiCapability: 'Catalog & Order Ingestion',
      features: ['Shop Product Import', 'Order Info Ingestion', 'Inventory Align'],
      lastSync: undefined
    },
    {
      id: 'quickbooks',
      ...
      description: 'Exports purchase orders, cost of goods sold (COGS), and inventory valuations as journal entries.',
      aiCapability: 'Journal Entry Auto-Export',
      features: ['COGS Journal Entries', 'PO Exporting', 'Valuation Sync'],
      lastSync: undefined
    },
    {
      id: 'paypal',
      ...
      description: 'Imports daily sales transactions for bookkeeping and tax reporting.',
      aiCapability: 'Tax & Transaction Reconciliation',
      features: ['Daily Sales Import', 'Bookkeeping Sync', 'Tax Reporting'],
      lastSync: undefined
    }
  ]);
