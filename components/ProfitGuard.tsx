            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="luxury-card bg-white/5 border border-white/10 p-3.5 sm:p-6 lg:p-12 shadow-sm rounded-3xl">
                        <h3 className="text-lg sm:text-2xl lg:text-3xl uppercase text-white sm:text-white/50 mb-8 font-display font-medium tracking-widest">Production Inputs</h3>
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="relative">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white sm:text-white/40 text-sm sm:text-base lg:text-xl sm:text-slate-400 leading-relaxed sm:text-lg font-sans">$</span>
                                    <Input 
                                        type="number" 
                                        value={materialCost} 
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="p-[1.5px] rounded-[3rem] bg-gradient-to-r from-[#06B6D4] via-[#A855F7] via-[#D946EF] to-[#C5A059] shadow-[0_0_20px_rgba(168,85,247,0.2)]">
                        <div className="p-3.5 sm:p-6 lg:p-12 border-none shadow-sm bg-[#0A0A0A] rounded-[3rem] relative overflow-hidden">
                            <div className="flex flex-col md:flex-col sm:flex-col sm:flex-row justify-between items-start md:items-center gap-3 sm:gap-6 relative z-10">
                                <div>
                                    <h3 className="text-lg sm:text-2xl lg:text-3xl uppercase text-white sm:text-white/50 mb-2 font-display font-medium tracking-widest">Total Batch Profitability</h3>
                                    <p className="text-sm sm:text-base font-black tracking-tight text-white mb-4 font-sans">${totalProfit.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                                </div>
                    ...
                    <div className="p-3.5 sm:p-6 lg:p-12 bg-white/5 rounded-[2rem] border border-white/10">
                        <h6 className="text-[10px] font-bold text-white sm:text-white/50 uppercase mb-4 font-sans">Strategic Recommendations</h6>
...
const AnalysisCard = ({ title, value, subtitle, icon: Icon, highlight }: any) => (
    <div className={`p-4 sm:p-5 lg:p-6 rounded-3xl border transition-all duration-500 hover:shadow-2xl ${highlight ? 'bg-gradient-to-br from-[#6A2C91]/20 to-transparent border-[#6A2C91]/30' : 'bg-white/5 border-white/10'}`}>
        ...
        <h4 className="text-sm font-bold text-white mb-1 font-sans">{title}</h4>
...
const StatMini = ({ label, value }: any) => (
    <div>
        ...
        <p className="text-sm sm:text-base font-black tracking-tight text-white mb-4 font-sans">{value}</p>
    </div>
);
