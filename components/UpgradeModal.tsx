    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        <motion.div 
          ...
          className="relative w-full max-w-2xl bg-black/60 border border-white/10 rounded-[3rem] p-4 sm:p-5 lg:p-6 sm:p-12 shadow-[0_0_50px_rgba(106,44,145,0.15)] overflow-hidden backdrop-blur-3xl"
        >
          {/* Background Glow */}
          <div className="absolute top-0 right-0 w-full sm:w-96 h-[250px] sm:h-96 bg-[#C5A059] opacity-[0.03] rounded-bl-full -mr-20 -mt-8 sm:mt-12 lg:mt-20"></div>

          <button onClick={onClose} className="absolute top-4 sm:p-5 lg:p-6 right-8 text-white sm:text-white/40 hover:text-white transition-colors z-10">
            <X size={24} />
          </button>
          
          <div className="relative z-10">
            <div className="mb-10 flex items-center gap-3 sm:gap-6">
              <div className="w-12 h-12 sm:w-20 sm:h-20 bg-gradient-to-br from-[#6A2C91]/30 to-[#C5A059]/20 border border-white/10 rounded-2xl flex items-center justify-center shadow-inner">
            ...
            <div className="flex flex-col sm:flex-col sm:flex-col sm:flex-row gap-3 sm:gap-4">
              <Button 
                variant="ghost" 
                onClick={onClose}
              ...
              <Button 
                ...
                className="flex-1 py-3 px-6 bg-gradient-to-r from-[#C5A059] to-[#b08e4d] hover:from-[#b08e4d] hover:to-[#9c7d42] border-none text-white rounded-full font-black tracking-[0.2em] text-[11px] shadow-[0_0_20px_rgba(197,160,89,0.3)] transition-all"
              >
