...
const sizeStyles = {
  ...
  lg: { container: 'w-8 h-8 sm:w-12 sm:h-12 rounded-2xl', icon: 'w-7 h-7' },
  xl: { container: 'w-12 h-12 sm:w-20 sm:h-20 rounded-[2rem]', icon: 'w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10' },
};
